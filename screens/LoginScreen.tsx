...
//   const authStore = useLocalObservable(() => AuthStore.create({}));
...
//         disabled={formik.isSubmitting || authStore.isLoading}
//       >
//         {authStore.isLoading ? (
...
//   input: { width: '100%', height: 50, borderColor: '#ccc', borderWidth: 1, borderRadius: 8, paddingHorizontal: 15, marginBottom: 5 },
//   passwordContainer: { width: '100%', flexDirection: 'row', alignItems: 'center', marginBottom: 5 },
//   inputPassword: { flex: 1, height: 50, borderColor: '#ccc', borderWidth: 1, borderRadius: 8, paddingHorizontal: 15 },
